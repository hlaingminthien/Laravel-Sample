        ...
        <div class="row justify-content-center">
          <div class="col-lg-5 col-md-6 col-xs-12">
            <div class="page-login-form box">
              ...
              <form class="login-form" action="{{route('account.post_register')}}" method="post" id="registerform">
                @csrf
               ...
               <div class="form-group">
                   ...
                   <a href="{{route('employee_terms')}}" style="color:#00bcd4;">
              ...
              <ul class="form-links">
                <li class="text-center">Join as an employer<a href="{{route('account.employeer_register')}}" style="color:#00bcd4;">
                 Register as employeer</a></li>
              </ul>
              <ul class="form-links">
