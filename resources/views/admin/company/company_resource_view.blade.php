		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-xs-12">
				<div class="post-job box">
					...
					<form class="form-ad" action="{{route('admin.save_listresource')}}" method="post" id="companyresourceform">
						@csrf
						<input type="hidden" name="company_id" value="{{$company_id}}">
						<input type="hidden" name="user_id" value="{{$user_id}}">
						<div class="form-group">
							<label class="control-label">Account Name</label>
							<input type="text" name="name" class="form-control" value="{{$user_name}}" disabled>
						</div><br>
						<div class="form-group">
							<label class="control-label">Company Name</label>
							<input type="text" name="name" class="form-control" value="{{$company_name}}" disabled>
						</div><br>
						<div class="form-group">
							<label class="control-label">Card Type</label>
							<select ng-model="selectedcard" name="card_id" value="selectedcard" ng-change="selectCard()"  ng-options="card.id as card.card_name for card in cards"  class="form-control" ></select><br>
						</div><br>
						<div class="form-group">
							<div class="row">
						...
						<div class="form-check form-check-inline">
				  		{{ Form::checkbox('active',1,$active,['class'=>'form-check-input','id'=>'inlineCheckbox1']) }}
...
<script>
	...
	$scope.cards = cards;
    $scope.selectedcard = $scope.cards[0].id;
