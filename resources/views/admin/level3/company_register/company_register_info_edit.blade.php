        ...
        <div class="inner-box my-resume">
                  ...
                  <div class="author-info">
                    <div class="row"> 
                          ...
                          <div class="col-lg-12 col-md-12 col-xs-12">
                             ...
                             <h3>{{$company_infos[0]->company_name}}
                              @if($company_infos[0]->company_correct == 1)
            ...
            <div class="row basic_info">
                <div class="col-lg-4 col-md-3 col-xs-12">
                                  <h5>
                                      <span class="date">
                                        <img src="https://img.icons8.com/carbon-copy/30/000000/worldwide-location.png">
                                          {{$company_infos[0]->country_name}}/{{$company_infos[0]->state_name}}
                                      </span>
                                  </h5>
                                  <h5> 
                                      <span class="date">
                                  ...
                                  <h5>
                                    <span class="date">
                                          <img src="https://img.icons8.com/wired/30/000000/user-female.png">
                                        {{$company_infos[0]->member_name}}
                                    </span>
                                  </h5>
                </div>
                                      ...
                                      <h5>
                                        <span class="date">
                                             <img src="https://img.icons8.com/ios/30/000000/conference-background-selected.png">
                                                {{$company_infos[0]->no_of_employee}}
                                        </span>
                                      </h5>
...
<script>
  ...
  app.controller('myCtrl', function($scope, $http,$window) {
    ...
    $scope.editCompany = function(){
      ...
      $scope.country_id = $scope.company_infos.country_id;
      $scope.member_name = $scope.company_infos.member_name;
      $scope.no_of_employee = $scope.company_infos.no_of_employee;
