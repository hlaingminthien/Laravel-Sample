...
<div id="content" ng-app="myApp" ng-controller="myCtrl" class="back">
	<div class="container">
		<div class="row">
						  		...
						  		<div class="col-lg-3 col-md-3 col-xs-12">
									...
									<p class="sub-title">
										<img src="https://img.icons8.com/carbon-copy/32/000000/money-bag.png">
								  		{{number_format($edit_cv->expected_salary)}}MMK
								  	</p>
									<p>
										<span class="address">
					...
					<div class="about-me item">
						<div class="add-post-btn">
						 ...
						 <div class="row basic_info">
						    ...
						    <div class="col-lg-3 col-md-3 col-xs-12">
								<h5><span class="date">
									<img src="https://img.icons8.com/wired/28/000000/about-us-female.png">{{$edit_user->emergency_contact_name}}</span></h5>
								<h5><span class="date">
									<img src="https://img.icons8.com/wired/28/000000/phone.png">
									 {{$edit_user->emergency_phone}}</span></h5>
								<h5><span class="date">
					...
					<div class="education item">
						...
						<div class="row">
							...
							<h5>
								...
								<img src="https://img.icons8.com/ios/30/000000/certificate.png"> 
								{{ $train_certi->name }} 
							</h5>
					    	<h5>
					    		<span class="date">
					    			<img src="https://img.icons8.com/dotty/30/000000/new-resume-template.png"> {{ $train_certi->university }}
					    		</span>
					    	</h5>
					    	<h5>
					    		<span class="date">
					    			<img src="https://img.icons8.com/dotty/30/000000/new-resume-template.png"> {{ $train_certi->time_limit }}
							...
							<h5>
								<span class="date">
									<img src="https://img.icons8.com/ios/28/000000/date-to.png"> {{ $train_certi->start_date }}
							
									<img src="https://img.icons8.com/carbon-copy/25/000000/long-arrow-right.png"> {{ $train_certi->end_date }} 
