      ...
      <div class="col-lg-12 col-md-12 col-xs-12">
        <div class="inner-box my-resume">
          <div class="add-post-btn itm">
            <h3> CV Information 
               <!--  <a href="{{route('cv.cv_preview',['cv_id'=>$user_infos[0]->cv_id])}}" class="btn-added">Preview</a> -->
               <a href="#" class="btn-added" data-toggle="modal" data-target="#exampleModalCenter">Preview</a>
                  ...
                  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h6 class="modal-title" id="exampleModalCenterTitle">Print Or Download</h6>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                             <div class="col-5 offset-1">
                                 <p>
                                  <img src="https://img.icons8.com/officel/30/000000/print.png">
                                    <a href="{{route('cv.cv_preview',['cv_id'=>$user_infos[0]->cv_id])}}" class="btnprn">Print Preview</a>
                                </p>
                                 
                              </div> 
                              <div class="col-5">
                              <p>   
                                <img src="https://img.icons8.com/officel/30/000000/open-resume.png">
                                   <a href="{{route('cv.cv_preview2',['cv_id'=>$user_infos[0]->cv_id])}}" class="btnprn">Word/Html</a> 
                               </p>  
                              </div>
                    ...
                    <div class="modal-footer">
                        ...
                        Thanks for using our website.</h6>
              ...
              <div class="float-right">
                <a href="#" class="btn-added" ng-click="refreshcv()">Refresh</a>
              </div>
            </h3>
          </div>
            ...
            <div class="author-info">
              ...
              <div class="row">
                <div class="col-lg-4 col-md-4 col-xs-12">
                  <p class="sub-title">
                    <img src="https://img.icons8.com/dotty/30/000000/businesswoman.png"> {{$user_infos[0]->job_position}}</p>
                  <p><span class="address">
                    <img src="https://img.icons8.com/dotty/26/000000/type.png">
                     {{$user_infos[0]->job_category}}</span></p>
                  <p><span>
                    <img src="https://img.icons8.com/dotty/28/000000/permanent-job.png">
                    {{$user_infos[0]->experlevel}}</span></p>
                  ...
                  <p><span><img src="https://img.icons8.com/dotty/30/000000/worldwide-location.png"> 
                    {{$user_infos[0]->employment_type}}</span></p>
                  </div>
                  ...
                  <p class="sub-title">
                    ...
                    bond with previous company
                  </p>
                  <p>
                    <span class="address">
                      <img src="https://img.icons8.com/wired/30/000000/permanent-job.png"> {{$user_infos[0]->limit_jobs_with_prev_company}}
                      limit jobs with previous company
                    </span>
                  </p>
                  <p>
                    <span class="address">
                      <img src="https://img.icons8.com/small/25/000000/available-updates.png"> {{$user_infos[0]->updated_date}}
                    </span>
                  </p>
                  </div>
              </div>
          ...
          <div class="about-me item">
            <div class="add-post-btn">
             ...
             <div class="row basic_info">
              <div class="col-lg-3 col-md-3 col-xs-12">
                <h5>
                  <span class="date"><img src="https://img.icons8.com/ios/25/000000/email-open.png">{{$user_infos[0]->email}}</span>
                </h5>
                <h5> 
                    <span class="date"><img src="https://img.icons8.com/dotty/28/000000/ringing-phone.png"> {{$user_infos[0]->phone}}</span>
                </h5>
                <h5><span class="date"><img src="https://img.icons8.com/ios/27/000000/identification-documents.png"> {{$user_infos[0]->nrc}}</span></h5>
                <h5><span class="date"><img src="https://img.icons8.com/ios/30/000000/drag-gender-neutral.png"> {{$user_infos[0]->gender}}</span></h5>
                </div>
                <div class="col-lg-3 col-md-3 col-xs-12">
                <h5><span class="date"><img src="https://img.icons8.com/ios/28/000000/multicultural-people.png"> {{$user_infos[0]->race}}</span></h5>
                <h5><span class="date"><<img src="https://img.icons8.com/ios/28/000000/pray.png">
                 {{$user_infos[0]->religious}}
                </span></h5>
                <h5><span class="date"><img src="https://img.icons8.com/wired/30/000000/order-delivered.png">
                 {{$user_infos[0]->native_town}}</span></h5>
                <h5><span class="date"><img src="https://img.icons8.com/ios/26/000000/birth-date.png">  
                 {{$user_infos[0]->date_of_birth}}</span>
                </h5>
                </div>
                <div class="col-lg-3 col-md-3 col-xs-12">
                <h5><span class="date"><img src="https://img.icons8.com/ios/28/000000/scale.png"> {{$user_infos[0]->weight}}</span></h5>
                <h5><span class="date"><img src="https://img.icons8.com/ios/28/000000/height.png"> {{$user_infos[0]->height}}</span></h5>
                <h5><span class="date"><img src="https://img.icons8.com/wired/26/000000/like.png">
                ...
                <h5><span class="date"><img src="https://img.icons8.com/wired/28/000000/phone.png">
                 {{$user_infos[0]->emergency_phone}}</span></h5>
                <h5><span class="date"><img src="https://img.icons8.com/cotton/28/000000/family.png">{{$user_infos[0]->relation_with_econtact}}</span></h5>
            ...
            <div ng-repeat="x in work_exps" ng-if="work_exps !== null">
              ...
              <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-6">
                  ...
                  <h5><span class="date">
                    <img src="https://img.icons8.com/dotty/26/000000/type.png"> <% x.job_cat_name %></span></h5>
                  <h5><span class="date"><img src="https://img.icons8.com/dotty/28/000000/permanent-job.png"> <% x.job_exp_name %></span></h5>
                </div>
                <div class="col-lg-6 col-md-6 col-xs-6">
                  <h5>
                    <span class="date">
                      <img src="https://img.icons8.com/ios/28/000000/date-to.png"> <% x.star_date %> 
                      <img src="https://img.icons8.com/carbon-copy/25/000000/long-arrow-right.png"></i> <% x.end_date %>
                    </span>
                  </h5>
                  <h5>
                    <span class="date">
              ...
              <div class="add-post-btn">
                ...
                <div class="col-lg-6 col-md-6 col-xs-6">
                  <h5>
                    ...
                    <h5>
                      <span class="date">
                        <img src="https://img.icons8.com/dotty/30/000000/university.png">
                        <% y.university %>
                      </span>
                    </h5>
                  </div>
                  <div class="col-lg-6 col-md-6 col-xs-6">
                    <h5>
                      <span class="date">
                        <img src="https://img.icons8.com/dotty/30/000000/future.png">
                        <% y.time_limit %>
                      </span>
                    </h5>
                  <h5>
           ...
           <!-- start -->
              ...
              @csrf
                ...
                <div class="form-group">
                  ...
                  <div style="color:red" ng-show="workexpForm.star_date.$dirty && workexpForm.star_date.$invalid" id="startDate_error">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <input type="date" name="star_date"  ng-model="star_date" class="form-control" placeholder="Start date" required>
                <div style="color:red" ng-show="EditWexpForm.star_date.$dirty && EditWexpForm.star_date.$invalid">
                    <span ng-show="EditWexpForm.star_date.$error.required">Start date is required.</span>
                  </div>
                  <div style="color:red" ng-show="!EditWexpForm.star_date.$dirty && star_date==undefined" id="editStartDate_error">
                    <h5></h5>
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-ad">
                ...
                <div class="form-group">
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="customRadioInline1" ng-model="time_limit" value="full" name="time_limit" class="custom-control-input">
                    <label class="custom-control-label" for="customRadioInline1">Full Time</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="customRadioInline2" ng-model="time_limit" value="part" name="time_limit" class="custom-control-input">
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                  ...
                  <select class="form-control" id="location" name="native_town" ng-model="native_town">
                    @foreach($states as $state)
            ...
            <div class="form-group">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                  ...
                  <div class="lb_symbol">
                    <input type="text" name="weight" ng-model="weight" class="form-control" placeholder="e.g. 185" required>
                  </div>
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                  ...
                  <div class=row>
                    <div class="col-lg-6 col-md-6 col-xs-12 feet-symbol">
                      <input type="text" name="feet" ng-model="feet" class="form-control" placeholder="e.g. 5 " required>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 inches-symbol">
                      <input type="text" name="inches" ng-model="inches" class="form-control" placeholder="e.g. 6 " required>
                    </div>
...
//cv
  $scope.refreshcv = function()
  {
    ...
    $scope.state_id = $scope.user_infos.cv_state_id;
...
//basic user info
  $scope.editbasicuser = function(){
    ...
    $scope.feet = $scope.user_infos.height.substring(0, 1);
    if ($scope.user_infos.height.substring(2, 4).includes('"'))
    {
      $scope.inches = $scope.user_infos.height.substring(2, 3);
    }
    else
    {
      $scope.inches = $scope.user_infos.height.substring(2, 4);
    }
